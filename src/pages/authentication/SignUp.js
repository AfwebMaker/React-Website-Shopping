          ...
          <div className="w-1/2 h-full bg-fuchsia-400 flex items-center justify-center">
            <div className="flex p-6 rounded-lg shadow-lg bg-white max-w-md">
              <form>
                ...
                <a
                  className="px-7 py-3 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center mb-3 bg-[#3b599]"
