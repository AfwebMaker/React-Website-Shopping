...
const people = [
  { name: 'همه عکس ها' },
  { name: 'Adobi IIIustrator' },
  { name: 'Adodi Photoshop' },
  { name: 'Adobi XD' },
  { name: 'Figma' },
...
export default function ListboxDownload() {
      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative w-full">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="menuScroll absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-2 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
